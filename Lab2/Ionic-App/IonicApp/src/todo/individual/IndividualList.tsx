    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                <IonLoading isOpen={fetching} message="This might take a while..."/>
                    ...
                    visibleIndividuals &&(
                        ...
                        <IonList>
                            ...
                            {Array.from(visibleIndividuals)
                                .filter(each => {
                                    console.log(visibleIndividuals)
                                    if (filter !== undefined)  
                                        return each.vaccinated === filter && each._id !== undefined;
                                    return each._id !== undefined;
                                })
                                .map(({_id: _id, name, age, vaccinated}) => 
                                <Individual key={_id} _id={_id} name={name} age={age} vaccinated={vaccinated || false}  onEdit={_id => history.push(`/api/individuals/individual/${_id}`)} />)}
                        </IonList>
                    )
                }
