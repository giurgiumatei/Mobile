        ...
        <IonReactRouter>
          <IonRouterOutlet>
            <AuthProvider>
              ...
              <IndividualProvider>
                <PrivateRoute path="/api/individuals" component={IndividualList} exact={true} />
                <PrivateRoute path="/api/individuals/individual" component={IndividualEdit} exact={true} />
                <PrivateRoute path="/api/individuals/individual/:id" component={IndividualEdit} exact={true} />
              </IndividualProvider>
              <Route exact path="/" render={() => <Redirect to="/api/individuals" />} />
            </AuthProvider>
          </IonRouterOutlet>
        </IonReactRouter>
  </IonApp>
